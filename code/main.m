...
% HPC Paths
patches_dir = "/scratch/users/axa1399/ccf_ovarian_cancer/patches/";
patches = dir(fullfile("/scratch/users/axa1399/ccf_ovarian_cancer/histoqc_masks/", '*.png'));
epi_stroma_masks_dir = "/scratch/users/axa1399/ccf_ovarian_cancer/epi_stroma_masks/";
nuclei_masks_dir = "/scratch/users/axa1399/ccf_ovarian_cancer/nuclei_masks/";
histoqc_masks_dir = "/scratch/users/axa1399/ccf_ovarian_cancer/histoqc_masks/";
collagen_masks_dir = "/scratch/users/axa1399/ccf_ovarian_cancer/results/collagen_feature_maps_350/";
