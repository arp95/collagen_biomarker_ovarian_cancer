...
feature_maps_dir = "/scratch/users/rnd27/uh_endometrium_cancer/results/collagen_feature_maps_350/";
files = dir(fullfile(files_dir, '*.csv'));
feature_maps = dir(fullfile(feature_maps_dir, '*.mat'));
collagen_masks_dir = "/mnt/rstor/CSE_BME_AXM788/home/axa1399/uh_endometrial_cancer/collagen_feature_maps_350_final/";
