...
patches = "/scratch/users/axa1399/upmc_ovarian_cancer/patches/"
epi_stroma_masks = "/mnt/rstor/CSE_BME_AXM788/home/axa1399/upmc_ovarian_cancer/epi_stroma_masks/"
output_patches = "/scratch/users/axa1399/upmc_ovarian_cancer/patches_epithelium/"

masks = glob.glob(patches + "*")
masks = masks[10000:15000]
for mask in masks:
